					...
					<div class="col-xl-6 col-md-9 top-right-nav-w3ls mt-2 text-md-right text-center">
						<ul>
							...
							<li class="mx-xl-5 mx-3">
								<a href="#special" class="text-dark scroll">Services</a>
								  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
 <a class="dropdown-item" href="http://www.trip2tirupati.com/cabServices.html" class="img-color">TRIP2TIRUPATI</a>
               <a class="dropdown-item" href="http://www.ka-chow.com/" class="img-color">KA-CHOW</a>
               <a class="dropdown-item" href="#" class="img-color">ELACHI</a>
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item scroll" href="#">5000</a>
									<a class="dropdown-item scroll" href="#">5000-10,000</a>
									<a class="dropdown-item scroll" href="#">10,000-15,000</a>
									<a class="dropdown-item scroll" href="#">ABOVE</a>
				...
				<div class="col-xl-8 col-md-6 col-sm-5 p-0 text-sm-left text-center">
					...
					<h1>
						<a class="navbar-brand font-weight-bold" href="index.html">
							Event
							<span class="font-weight-light mr-1">Surprise</span>
						...
						<ul class="navbar-nav mr-lg-auto text-center">
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item scroll" href="#">CAKES</a>
									<a class="dropdown-item scroll" href="#">PLANTS</a>
									<a class="dropdown-item scroll" href="#">BOUQUET</a>
									<a class="dropdown-item scroll" href="#">CHOCOLATES</a>
									<a class="dropdown-item scroll" href="#">GREETING CARDS</a>
									<a class="dropdown-item scroll" href="#">CUPS</a>
									<a class="dropdown-item scroll" href="#">MUGS</a>
									<a class="dropdown-item scroll" href="#">PHOTOFRAMES</a>
									<a class="dropdown-item scroll" href="#">PILO(LOGS)</a>
									<a class="dropdown-item scroll" href="#">TEDDYBEAR</a>
		
										</div>
							</li>
							<li class="dropdown">
	            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:white;">SPECIAL OCCASION <b class="caret"></b></a>
		            ...
		            <div class="row">
			            ...
			            <div class="col-sm-4">
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item scroll" href="#">EVERYDAY</a>
									<a class="dropdown-item scroll" href="#">BIRTHDAY</a>
									<a class="dropdown-item scroll" href="#">ANNIVERSARY</a>
									<a class="dropdown-item scroll" href="#">CONGRATULATIONS</a>
									<a class="dropdown-item scroll" href="#">GOODLUCK</a>
									<a class="dropdown-item scroll" href="#">GETWELLSOON</a>
									<a class="dropdown-item scroll" href="#">RAKSHNABANDHAN</a>
									<a class="dropdown-item scroll" href="#">FRIENDSHIPDAY</a>
									<a class="dropdown-item scroll" href="#">DAUGHTERDAY</a>	
									<a class="dropdown-item scroll" href="#">CHILDRENSDAY</a>
									<a class="dropdown-item scroll" href="#">CHRISTMAS</a>
									<a class="dropdown-item scroll" href="#">VALENTINESDAY</a>
									<a class="dropdown-item scroll" href="#">PROMISEDAY</a>
									<a class="dropdown-item scroll" href="#">FATHERSDAY</a>
									<a class="dropdown-item scroll" href="#">PARENTSDAY</a>
									<a class="dropdown-item scroll" href="#">MOTHERDAY</a>
									<a class="dropdown-item scroll" href="#">NEWYEAR</a>
									<a class="dropdown-item scroll" href="#">TEACHERSDAY</a>
									<a class="dropdown-item scroll" href="#">WOMENSDAY</a>
								</div>
							</li>
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									 ...
									 <a class="dropdown-item" href="<?php echo site_url('auth/login') ?>" class="img-color">MYACCOUNT</a>
                              <a class="dropdown-item" href="trackin.html" class="img-color">TRACK</a>
                             <a class="dropdown-item" href="Order.html" class="img-color">ORDER</a>
		...
		<div class="wrap">
			<div class="row banner-agiles">
				<div class="col-xl-6 banner-w3lstexts text-white pt-xl-4">
					<h3 class="font-weight-bold" id="text">Parties </h3>
					<p class="text-white mt-md-4 mt-3">Specializing in organizing all kinds of events for toddlers, kids and
						teenagers, we mainly focus on clowns and birthdays,
		...
		<div class="wrap py-xl-5 py-lg-3">
			<div class="row">
				<div class="col-xl-6 left-midd-agile pr-5">
					...
					<p>Sed ut perspiciatis unde omnis iste natus error olorlaudantium, dsdstotam rem aperiam.</p>
			...
			<div class="row agileits-w3layouts-grid pt-md-4">
				<div class="col-lg-4 services-agile-1">
					<div class="d-flex wthree_agile_us bg-white py-4">
						...
						<div class="col-10 agile-why-text">
							<h4 class="text-dark font-weight-bold mb-3">Party Planning</h4>
							<p>Lorem ipsum magna, vehicula ut scelerisque ornare.</p>
				...
				<div class="col-lg-4 services-agile-1 my-lg-0 my-4">
					<div class="d-flex wthree_agile_us bg-white py-4">
						...
						<div class="col-10 agile-why-text">
							<h4 class="text-dark font-weight-bold mb-3">Party Styling</h4>
							<p>Lorem ipsum magna, vehicula ut scelerisque ornare.</p>
							<a class="btn mt-3 service-button p-0 scroll" href="#who" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
				...
				<div class="col-lg-4 services-agile-1">
					<div class="d-flex wthree_agile_us bg-white py-4">
						...
						<div class="col-10 agile-why-text">
							<h4 class="text-dark font-weight-bold mb-3">Party Catering</h4>
							<p>Lorem ipsum magna, vehicula ut scelerisque ornare.</p>
							<a class="btn mt-3 service-button p-0 scroll" href="#who" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
			...
			<div class="row agileits-w3layouts-grid mt-lg-5 mt-4">
				<div class="col-lg-4 services-agile-1">
					<div class="d-flex wthree_agile_us bg-white py-4">
						...
						<div class="col-10 agile-why-text">
							<h4 class="text-dark font-weight-bold mb-3">Party Gifts</h4>
							<p>Lorem ipsum magna, vehicula ut scelerisque ornare.</p>
							<a class="btn mt-3 service-button p-0 scroll" href="#who" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
	...
	<div class="who-agile" id="who">
		<div class="wrap py-xl-5 py-lg-3">
			<div class="text-center style-agile-2 py-5 px-4">
				<h3 id="special" class="tittle-2 text-dark font-weight-bold mb-5">Our Special Services</h3>
				<div class="row">
					<div class="col-sm-4 exce-grid1-mmstyle">
						<div class="grid-ec1-2 pt-4 px-xl-4 px-2">
							<i class="fas fa-car"></i>
							<h4 class="my-3 mx-lg-3 text-dark">TRIP2TIRUPATI</h4>

						 <a class="btn banner-button button-w3ls style-button" href="http://www.trip2tirupati.com/cabServices.html" target="_blank">BOOK</a>
					...
					<div class="col-sm-4 exce-grid1-mmstyle my-sm-0 my-4">
						<div class="grid-ec1-2 pt-4 px-xl-4 px-2">
							...
							<h4 class="my-3 mx-lg-3 text-dark">ELACHI</h4>
							<a class="btn banner-button button-w3ls style-button" href="#" target="_blank">BOOK</a>
					...
					<div class="col-sm-4 exce-grid1-mmstyle">
						<div class="grid-ec1-2 pt-4 px-xl-4 px-2">
							...
							<h4 class="my-3 mx-lg-3 text-dark">KA-CHOW</h4>
							<a class="btn banner-button button-w3ls style-button" href="#" target="_blank">BOOK</a></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row text-center style-agile">
				<div class="col-lg-4 exce-grid1-mmstyle">
					<div class="grid-ec1 bg-white py-5 px-4">
						...
						<h4 class="mb-3 mx-3">Sed ut perspiciatis unde omnis iste natus</h4>
			...
			<div class="row choose-main mt-lg-5 mt-4">
				<div class="col-sm-6">
					<div class="row">
						...
						<div class="col-xl-6 galsses-grid-right mt-xl-0 mt-4">
							<h5>
								<span class="post-color">08</span> June 2018</h5>
							<h4 class="post my-3">
								<a href="#">Lorem ipsum dolor sit amet</a>
							</h4>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
				...
				<div class="col-sm-6 mt-sm-0 mt-4">
					<div class="row">
						...
						<div class="col-xl-6 galsses-grid-right mt-xl-0 mt-4">
							<h5>
								<span class="post-color">11</span> June 2018</h5>
							<h4 class="post my-3">
								<a href="#">Lorem ipsum dolor sit amet</a>
							</h4>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row contact-form py-3">
				...
				<div class="col-lg-6 map mt-lg-0 mt-5">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3877.5947171633584!2d79.3825275141955!3d13.621546990431819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a4d4b0c3cc2afa7%3A0xbe5ad0250734142e!2sITPROFOUND!5e0!3m2!1sen!2sin!4v1547706563710"					    allowfullscreen></iframe>
				</div>
				<!-- //contact details -->
			</div>
		</div>
